  ...
  <div class="addlist">
    ...
    <el-form
      ...
      <el-form-item label="市场价:" prop="original_price">
        <el-input v-model="listQuery.original_price" class="input-width"></el-input>
      </el-form-item>
...
export default {
    ...
    data(){
      return{
        ...
        //表单验证
        rules:{
          //product_cate_id: [{required: true, message: '请选择商品分类', triggle: 'blur'}],
          name: [
